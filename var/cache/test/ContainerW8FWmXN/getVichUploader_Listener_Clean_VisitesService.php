 ...
 */
class getVichUploader_Listener_Clean_VisitesService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.visites' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.visites'])) {
            return $container->privates['vich_uploader.listener.clean.visites'];
        }

        return $container->privates['vich_uploader.listener.clean.visites'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('visites', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
