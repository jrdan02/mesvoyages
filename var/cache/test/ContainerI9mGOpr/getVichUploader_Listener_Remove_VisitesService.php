 ...
 */
class getVichUploader_Listener_Remove_VisitesService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.visites' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['vich_uploader.listener.remove.visites'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('visites', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), ($container->services['vich_uploader.upload_handler'] ?? $container->load('getVichUploader_UploadHandlerService')));
    }
}
