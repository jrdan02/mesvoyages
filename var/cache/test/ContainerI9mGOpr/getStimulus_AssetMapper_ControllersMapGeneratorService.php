 ...
 */
class getStimulus_AssetMapper_ControllersMapGeneratorService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['stimulus.asset_mapper.auto_import_locator'] ?? $container->load('getStimulus_AssetMapper_AutoImportLocatorService'));
