...
class __TwigTemplate_089796cfed02e2b3e7f35415fd31498c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_summary($context, array $blocks = [])
    {
        ...
        if (array_key_exists("profile", $context)) {
            // line 10
            yield "                ";
            $context["request_collector"] = ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["profile"] ?? null), "collectors", [], "any", false, true, false, 10), "request", [], "any", true, true, false, 10)) ? (Twig\Extension\CoreExtension::defaultFilter(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["profile"] ?? null), "collectors", [], "any", false, true, false, 10), "request", [], "any", false, false, false, 10), false)) : (false));
            // line 11
            yield "
                ";
            // line 12
...
($context["profile"] ?? null), "collectors", [], "any", false, true, false, 14), "command", [], "any", true, true, false, 14)) ? (Twig\Extension\CoreExtension::defaultFilter(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["profile"] ?? null), "collectors", [], "any", false, true, false, 14), "command", [], "any", false, false, false, 14), false)) : (false)), "request_collector" =>             // line 15
...
(isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 17, $this->source); })())], false);
    ...
    public function block_sidebar($context, array $blocks = [])
    {
        ...
        yield "
                                ";
        // line 40
        yield $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("web_profiler.controller.profiler::searchBarAction", array(), Twig\Extension\CoreExtension::arrayMerge(["type" => (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 40, $this->source); })())], CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 40, $this->source); })()), "query", [], "any", false, false, false, 40), "all", [], "any", false, false, false, 40))));
        yield "
                            </div>
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new RuntimeError('Variable "menu" does not exist.', 59, $this->source); })()))) {
                    ...
                    yield "\">
                                                <a href=\"";
                    // line 61
                    yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", ["token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 61, $this->source); })()), "panel" => $context["name"], "type" => (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 61, $this->source); })())]), "html", null, true);
                    yield "\">";
    ...
    public function block_sidebar_shortcuts_links($context, array $blocks = [])
    {
        ...
        // line 31
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler_search", ["limit" => 10, "type" => (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 31, $this->source); })())]), "html", null, true);
        yield "\">Last 10</a>
                                        <a class=\"btn btn-link\" href=\"";
        // line 32
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", Twig\Extension\CoreExtension::arrayMerge(["token" => "latest", "type" => (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 32, $this->source); })())], CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 32, $this->source); })()), "query", [], "any", false, false, false, 32), "all", [], "any", false, false, false, 32))), "html", null, true);
        yield "\">Latest</a>
    ...
    {
        return array (  340 => 76,  325 => 35,  319 => 34,  314 => 32,  310 => 31,  307 => 30,  297 => 29,  284 => 69,  280 => 67,  276 => 65,  262 => 64,  254 => 61,  247 => 60,  244 => 59,  239 => 55,  231 => 54,  229 => 53,  226 => 52,  209 => 51,  206 => 50,  203 => 49,  200 => 48,  197 => 47,  194 => 46,  192 => 45,  189 => 44,  187 => 43,  181 => 40,  178 => 39,  176 => 29,  172 => 27,  162 => 26,  151 => 20,  147 => 18,  145 => 17,  144 => 16,  143 => 15,  142 => 14,  141 => 13,  140 => 12,  137 => 11,  134 => 10,  131 => 9,  121 => 8,  105 => 77,  103 => 76,  99 => 75,  93 => 71,  91 => 26,  84 => 21,  82 => 8,  76 => 5,  73 => 4,  63 => 3,  40 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Profiler/layout.html.twig", "/opt/homebrew/var/www/mesvoyages0.1/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/layout.html.twig");
    }
}
