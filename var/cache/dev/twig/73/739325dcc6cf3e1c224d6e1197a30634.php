...
class __TwigTemplate_d99b62a461bdef14d8caea8e5356b525 extends Template
{
    private $source;
    private $macros = [];
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 71, $this->source); })()), "enabled", [], "any", false, false, false, 71)) {
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 72, $this->source); })()), "token", [], "any", false, false, false, 72)) {
                        ...
                        <div class=\"sf-toolbar-info-piece\">
                            ...
                            <span>";
                        // line 119
                        yield $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 119, $this->source); })()), "tokenClass", [], "any", false, false, false, 119), "html", null, true));
                        yield "</span>
                        </div>
                    ";
                    } else {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["authenticator"]) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["badge"]) {
                        ...
                        yield "\">
                                            ";
                        // line 370
                        yield $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["badge"], "stub", [], "any", false, false, false, 370), "html", null, true));
                        yield "
                                            </span>
                                        ";
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/opt/homebrew/var/www/mesvoyages0.1/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
