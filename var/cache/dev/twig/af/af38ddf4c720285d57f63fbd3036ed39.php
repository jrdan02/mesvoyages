...
class __TwigTemplate_85fb11b54f0aa49f054eda6117517077 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 18
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["file"]) || array_key_exists("file", $context) ? $context["file"] : (function () { throw new RuntimeError('Variable "file" does not exist.', 18, $this->source); })()), "html", null, true);
        if ((0 < (isset($context["line"]) || array_key_exists("line", $context) ? $context["line"] : (function () { throw new RuntimeError('Variable "line" does not exist.', 18, $this->source); })()))) {
            yield " <small>line ";
            yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["line"]) || array_key_exists("line", $context) ? $context["line"] : (function () { throw new RuntimeError('Variable "line" does not exist.', 18, $this->source); })()), "html", null, true);
            yield "</small>";
        }
        yield "</h1>
        ...
        yield "                    </div>
                ...
                <div id=\"sidebar\">
                    <dl class=\"file-metadata\">
                        ...
                        <dd>";
        // line 32
        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["file_info"]) || array_key_exists("file_info", $context) ? $context["file_info"] : (function () { throw new RuntimeError('Variable "file_info" does not exist.', 32, $this->source); })()), "pathname", [], "any", false, false, false, 32), "html", null, true);
        yield "</dd>

                        <dt>Last modified:</dt>
                        <dd>";
        // line 35
        yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::dateFormatFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["file_info"]) || array_key_exists("file_info", $context) ? $context["file_info"] : (function () { throw new RuntimeError('Variable "file_info" does not exist.', 35, $this->source); })()), "mTime", [], "any", false, false, false, 35)), "html", null, true);
        yield "</dd>
        ...
        // line 39
        yield "                        ";
        $context["file_num_lines"] = (Twig\Extension\CoreExtension::lengthFilter($this->env, Twig\Extension\CoreExtension::splitFilter($this->env, (isset($context["source"]) || array_key_exists("source", $context) ? $context["source"] : (function () { throw new RuntimeError('Variable "source" does not exist.', 39, $this->source); })()), "
")) - 1);
        // line 40
        yield "                        <dd>
                            ";
        // line 41
        yield Twig\Extension\EscaperExtension::escape($this->env, ((((isset($context["file_size_in_kb"]) || array_key_exists("file_size_in_kb", $context) ? $context["file_size_in_kb"] : (function () { throw new RuntimeError('Variable "file_size_in_kb" does not exist.', 41, $this->source); })()) < 1)) ? ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["file_info"]) || array_key_exists("file_info", $context) ? $context["file_info"] : (function () { throw new RuntimeError('Variable "file_info" does not exist.', 41, $this->source); })()), "size", [], "any", false, false, false, 41) . " bytes")) : ((Twig\Extension\CoreExtension::numberFormatFilter($this->env, (isset($context["file_size_in_kb"]) || array_key_exists("file_size_in_kb", $context) ? $context["file_size_in_kb"] : (function () { throw new RuntimeError('Variable "file_size_in_kb" does not exist.', 41, $this->source); })()), 0) . " KB"))), "html", null, true);
        yield "
                            / ";
        // line 42
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["file_num_lines"]) || array_key_exists("file_num_lines", $context) ? $context["file_num_lines"] : (function () { throw new RuntimeError('Variable "file_num_lines" does not exist.', 42, $this->source); })()), "html", null, true);
        yield " lines
                        </dd>
                    </dl>
...
{% endblock %}
", "@WebProfiler/Profiler/open.html.twig", "/opt/homebrew/var/www/mesvoyages0.1/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/open.html.twig");
    }
}
